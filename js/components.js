...
function home() {
    ...
    <section class="section_home">
        ...
        <div class="grid_container_home">
            ...
            <div class="grid_item_home grid_item_home_3">Menú y promos </div>
            <div class="grid_item_home grid_item_home_4">Mi cuentas</div>
        </div>
    </section>
    */
    const $component = document.createElement("section");
    ...
    $element2.classList.add("h3_home");
    $element2.innerHTML = "Nos alegra mucho verte de nuevo";

    const $element3 = document.createElement("div");
    $element3.classList.add("grid_container_home");

    const $element4 = document.createElement("div");
    $element4.classList.add("grid_item_home", "grid_item_home_1");
    $element4.innerHTML = "Consultar";

    const $element5 = document.createElement("div");
    $element5.classList.add("grid_item_home", "grid_item_home_2");
    $element5.innerHTML = "Canjear"

    const $element6 = document.createElement("div");
    $element6.classList.add("grid_item_home", "grid_item_home_3");
    $element6.innerHTML = "Menú y promos";

    const $element7 = document.createElement("div");
    $element7.classList.add("grid_item_home", "grid_item_home_4");
    $element7.innerHTML = "Mi cuenta";

    $element3.append($element4, $element5, $element6, $element7);

    $component.append($element1,$element2,$element3);
